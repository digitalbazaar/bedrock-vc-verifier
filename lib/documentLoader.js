...
// FIXME: replace with vcb context package
/* eslint-disable */
const VCB_CONTEXT_V1 = {
  "@context": {
    "@protected": true,
    "id": "@id",
    "type": "@type",
...
bedrock.events.on('bedrock.init', () => {
  ...
  // FIXME: use vcb context package instead
  // add VCB context to bedrock document loader
  jsonLdDocumentLoader.addStatic(
    'https://w3id.org/vc-barcodes/v1', VCB_CONTEXT_V1);
});
