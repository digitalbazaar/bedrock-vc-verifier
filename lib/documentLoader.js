...
api.documentLoader = async url => {
  let result;
  if(url === 'https://w3c-ccg.github.io/vc-http-api/fixtures/revocationList.json') {
    return {
      contextUrl: null,
      document: {
        '@context': [
  ...
  if(
    url === `https://raw.githubusercontent.com/schemaorg/schemaorg/main/data/releases/11.0/schemaorgcontext.jsonld`) {
    return {
      contextUrl: null,
      document: {
        '@context': {
