...
describe('mDL /presentations/verify', () => {
  ...
  it('verifies a valid Annex C presentation', async () => {
    ...
    // create an Annex C MDL handover
    const handover = {
      type: 'dcapi',
  ...
  it.skip('verifies a valid Annex B presentation w/owf libs', async () => {
    // get device key pair
    const deviceKeyPair = await mdlUtils.generateDeviceKeyPair();
  ...
  it.skip('verifies a valid Annex C presentation w/owf libs', async () => {
    // get device key pair
    const deviceKeyPair = await mdlUtils.generateDeviceKeyPair();
